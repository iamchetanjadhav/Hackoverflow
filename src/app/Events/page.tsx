...
const Events = () => {
    ...
    const events: EventType[] = [
        ...
        },
        {
            ...
            fullDescription:
                "Free Fire tournament where players compete in intense battle royale matches. Teams must plan strategies, manage resources, and survive to win exciting prizes.",
            duration: "8 Hours",
            location: "Engineering Reception, Pillai HOC Campus",
    ...
    if (selectedEvent) {
        return (
            <section className="min-h-screen bg-gradient-to-br from-black via-[#0d0d0d] to-black text-white px-6 py-32 relative">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        <div
                            ...
                            className="relative h-[420px] w-full rounded-3xl overflow-hidden shadow-[0_0_60px_rgba(249,115,22,0.25)] cursor-zoom-in"
                        >
                            <Image
                        ...
                        <div>
                            ...
                            <div className="flex gap-6">
                                <a
                                    href="https://forms.gle/5h4fTREMg4y1AUoK9"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="px-10 py-4 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 font-semibold hover:scale-105 transition inline-block text-center"
                                >
                                    REGISTER NOW
                                </a>
    ...
    return (
        <section className="relative py-32 px-6 bg-gradient-to-b from-black via-[#0d0d0d] to-black overflow-hidden">
